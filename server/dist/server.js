...
import { parseAuthMessage, validateRoomAccess, addParticipant, removeParticipant, } from './auth.js';
import { handleSync, sendInitialSync, } from './handlers.js';
    ...
    ws.on('message', async (data) => {
        try {
            ...
            if (!initialized) {
                ...
                const hasAccess = await validateRoomAccess(authData.roomId, authData.userId, authData.isObserver || false);
                if (!hasAccess) {
                ...
                roomManager.addConnection(context.roomId, ws, context.userId, context.sessionId);
                ...
                await addParticipant(context.roomId, context.userId, context.sessionId);
