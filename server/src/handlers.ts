 ...
 */
function handleSyncStep2(encoder: encoding.Encoder, doc: Y.Doc) {
 ...
 */
function handleUpdate(decoder: decoding.Decoder, doc: Y.Doc) {
 ...
 */
function handleAwareness(message: Buffer, roomId: string) {
